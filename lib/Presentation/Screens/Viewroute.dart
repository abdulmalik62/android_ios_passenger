...
class view extends StatefulWidget {
  ...
  final String? Stop;
  const view({Key? key, required this.routeDrop, required this.routePickup,required this.Stop, required this.RouteId, required this.AttendanceId}) : super(key: key);

  @override
  State<view> createState() => _ConfirmationState();
}

class _ConfirmationState extends State<view> {
  LatLng? _startLatLng;
  LatLng? _endLatLng;
  LatLng? _stopLatLng;
  ...
  Future<void> _fetchJobCards() async {
    ...
    try {
      ...
      String apiUrl = '${ApiKey.baseUrl}/EmergencyMessageBasedScheduleId?routeId=${widget.RouteId}&date=$formattedDate'; // Format current date
                  ...
                  children: [
                    ...
                    Center(
                        child: TextButton(onPressed: (){
                          ...
                          child: Text("Go Back",style: TextStyle(color: Colours.orange,fontWeight: FontWeight.bold),),)
                    ),
                  ],
                ),
              ),
